...
RemoteTransmitter::RemoteTransmitter(unsigned char pin, unsigned int periodusec, unsigned char repeats) {
	_pin=pin;
...
unsigned long RemoteTransmitter::encodeTelegram(unsigned char trits[]) {
...
void RemoteTransmitter::sendTelegram(unsigned char trits[]) {
...
* d = data
*/
void RemoteTransmitter::sendTelegram(unsigned long data, unsigned char pin) {
...
void RemoteTransmitter::sendCode(unsigned char pin, unsigned long code, unsigned int periodusec, unsigned char repeats) {
...
ActionTransmitter::ActionTransmitter(unsigned char pin, unsigned int periodusec, unsigned char repeats) : RemoteTransmitter(pin,periodusec,repeats) {
	// Call constructor
}
...
BlokkerTransmitter::BlokkerTransmitter(unsigned char pin, unsigned int periodusec, unsigned char repeats) : RemoteTransmitter(pin,periodusec,repeats) {
	// Call constructor
}
...
KaKuTransmitter::KaKuTransmitter(unsigned char pin, unsigned int periodusec, unsigned char repeats) : RemoteTransmitter(pin,periodusec,repeats) {
	// Call constructor
}
...
ElroTransmitter::ElroTransmitter(unsigned char pin, unsigned int periodusec, unsigned char repeats) : RemoteTransmitter(pin, periodusec, repeats) {
	//Call constructor
}
