...
class RemoteTransmitter {
	public:
		...
		*/
		RemoteTransmitter(unsigned char pin, unsigned int periodusec, unsigned char repeats);
		...
		*/
		static void sendCode(unsigned char pin, unsigned long code, unsigned int periodusec, unsigned char repeats);
...
class ActionTransmitter: RemoteTransmitter {
	public:
		...
		*/
		ActionTransmitter(unsigned char pin, unsigned int periodusec=190, unsigned char repeats=4);
...
class BlokkerTransmitter: RemoteTransmitter {
	public:
		...
		* @see RemoteTransmitter
		*/
		BlokkerTransmitter(unsigned char pin, unsigned int periodusec=230, unsigned char repeats=4);
...
class KaKuTransmitter: RemoteTransmitter {
	public:
		...
		* @see RemoteTransmitter
		*/
		KaKuTransmitter(unsigned char pin, unsigned int periodusec=375, unsigned char repeats=4);
...
class ElroTransmitter: RemoteTransmitter {
	public:
		...
		* @see RemoteSwitch
		*/
		ElroTransmitter(unsigned char pin, unsigned int periodusec=320, unsigned char repeats=4);
